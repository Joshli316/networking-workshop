(function () {
  ...
  function toggleLang() {
    ...
    localStorage.setItem('nw_lang', isZh ? 'zh' : 'en');
  ...
  function revealActivity() {
    ...
    document.getElementById('poll-referral').classList.add('winner');
    document.getElementById('activity-answer').style.display = 'block';
    document.getElementById('reveal-btn-4').disabled = true;
  ...
  function revealQ2() {
    const slide = document.getElementById('slide-10');
    slide.dataset.phase = 'q3';
    document.getElementById('q2-answer').style.display = 'block';
    document.getElementById('q3-block').style.display = 'block';
  ...
  function revealQ3() {
    ...
    document.getElementById('q3-answer').style.display = 'block';
    document.getElementById('reveal-btn-q3').disabled = true;
    document.getElementById('nextBtn').disabled = false;
  }
  ...
  try {
    new QRCode(document.getElementById('qr-container'), {
      text: 'https://networking-workshop.pages.dev/resources',
      width: 148,
      height: 148,
      colorDark: '#047857',
      colorLight: '#ecfdf5'
    ...
    if (el) el.textContent = 'networking-workshop.pages.dev/resources';
  }
